# Run Selenium JavaScript Tests with SmartUI SDK on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Selenium JavaScript tests with SmartUI visual regression testing using HyperExecute. This sample shows how to configure Selenium JavaScript + SmartUI SDK + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-smartui-sdk-selenium-javascript && cd hyperexecute-smartui-sdk-selenium-javascript
npm install
```
